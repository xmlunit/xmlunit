...
public class JaxbBuilderTest {
    ...
    public void testMarchal_withJaxbRootObject_shouldReturnSource() throws Exception {
        ...
        // JDK 7+ uses the custom prefix "test"; JDK 6 uses a generated prefix like "ns2"
    ...
    @Test
    public void testMarchal_withJaxbObject_shouldReturnSource() throws Exception {
        // prepare test data
    ...
    public void testMarchal_withJaxbElement_shouldReturnSource() throws Exception {
        // prepare test data
        QName name = new QName("http://www.xmlunit.org/test/complexXml", "ComplexNode", "test");
